...
public abstract class PaginationActionImpl<T> extends SLSActionImpl<List<T>> implements PaginationAction<T> {

	protected static final Logger PAGINATION_LOG = S4JLogger.getLogger(PaginationAction.class);
	...
	public PaginationActionImpl(S4J api) {
		this(api, null);
	}
