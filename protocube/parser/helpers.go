...
// ValueToReplaceValue converts an interface{} value to a ReplaceValue.
// It handles strings, numbers, booleans, and null values.
func ValueToReplaceValue(value interface{}) (*ReplaceValue, error) {
	return NewReplaceValue(value)
}
